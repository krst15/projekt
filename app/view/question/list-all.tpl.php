...
<div id='questions'>
	<div class='top'>
		<p><?=$title?></p>
		<div class='menu'>
			<a href='<?=$this->url->create('questions/list-All/created' . $tagurl)?>' <?=$newest?>>Nyaste</a>
			<a href='<?=$this->url->create('questions/ask')?>'>Ställ fråga</a>
		</div>
		<div class='clear'></div>
	</div>
...
<div class='author-section'>
	<p>
		...
		{
			$edit = " | <small>
			<a href='". $this->url->create('questions/update/' . $c->getProperties()['id']). "'>Ändra i frågan <i class='fa fa-pencil'></i></a>
			</small>";
			echo $edit;
		}
		 ?>
